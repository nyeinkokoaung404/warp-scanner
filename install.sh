...
LATEST_VERSION=$(curl -fsSL https://raw.githubusercontent.com/nyeinkokoaung404/warp-scanner/main/VERSION)
...
curl -L -# -o "${ARCHIVE}" "https://github.com/nyeinkokoaung404/warp-scanner/releases/latest/download/${ARCHIVE}" && \
tar xzf "./${ARCHIVE}" && \
exec "./${BINARY}"
